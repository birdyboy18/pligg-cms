...
?>
				<?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['auto_id'] != 0): ?>
					...
					<?php endif; ?>
					<?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['spacercount'] > $this->_vars['submit_lastspacer']): ?>
						<ul class="dropdown-menu <?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['principlecat'] == 0): ?>sub-menu<?php endif; ?> sub-menu-show sub-menu-hide">
					<?php endif; ?>
					<li<?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['principlecat'] != 0): ?> class="dropdown"<?php endif; ?>>
					<a <?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['principlecat'] != 0): ?> class="dropdown-toggle active"<?php endif; ?> href="<?php if ($this->_vars['pagename'] == "new" || $this->_vars['groupview'] == "new"):  echo $this->_vars['URL_newcategory'].$this->_vars['cat_array'][$this->_sections['thecat']['index']]['safename'];  else:  echo $this->_vars['URL_maincategory'].$this->_vars['cat_array'][$this->_sections['thecat']['index']]['safename'];  endif;  if ($this->_vars['urlmethod'] == 2): ?>/<?php endif; ?>"><?php echo $this->_vars['cat_array'][$this->_sections['thecat']['index']]['name']; ?>
 <?php if ($this->_vars['cat_array'][$this->_sections['thecat']['index']]['principlecat'] != 0): ?><b class="caret"></b><?php endif; ?></a>
