<?php $this->_confs = array (
  ...
  'PLIGG_Visual_Search_Advanced' => 'Advanced Search',
  ...
  'PLIGG_Visual_Search_SearchDefaultText' => 'Search For Tutorials',
  'PLIGG_Visual_Search_Status' => 'Search Status',
  'PLIGG_Visual_Search_Status_All' => 'All',
  'PLIGG_Visual_Search_Status_Published' => 'Published',
  'PLIGG_Visual_Search_Status_New' => 'New',
  'PLIGG_Visual_Search_Go' => 'Go',
  'PLIGG_Visual_404_Title' => 'The page you were looking for doesn\'t exist!',
  'PLIGG_Visual_404_Description' => 'It may have been removed or you may have arrived here by using a bad URL',
  'PLIGG_Visual_404_Options' => '<li>Try searching for the article you are looking for.</li><li>Visit the Homepage to see the most recent stories.</li><li>Browse categories and tags to find a related story.</li>',
  'PLIGG_Visual_Published_News' => 'Published Tutorials',
  'PLIGG_Visual_Home_Title' => 'Published',
  'PLIGG_Visual_Recently_Pop' => 'Most Recent',
  'PLIGG_Visual_Top_Today' => 'Top Today',
  'PLIGG_Visual_Yesterday' => 'Yesterday',
  'PLIGG_Visual_This_Week' => 'Week',
  'PLIGG_Visual_This_Month' => 'Month',
  'PLIGG_Visual_This_Year' => 'Year',
  'PLIGG_Visual_Pligg_Queued_Sort' => 'Sort',
  'PLIGG_Visual_Pligg_Queued_Sort_By' => 'by',
  'PLIGG_Visual_Pligg_Queued' => 'New',
  'PLIGG_Visual_Pligg_Sort_News_By' => 'Sort Tutorials by',
  ...
  'PLIGG_Visual_What_Is_Pligg_Text' => 'Pligg is an open source content management system that lets you easily <a href=\'http://pligg.com\'>create your own user-powered website</a>.',
  ...
  'PLIGG_Visual_Latest_Comments' => 'Latest Comments',
  'PLIGG_Visual_Top_5_Tags' => 'Top Tags',
  'PLIGG_Visual_Pligg_For_Stories' => 'Vote for Stories',
  'PLIGG_Visual_Submit_A_New_Story' => 'Add New Tutorial',
  ...
  'PLIGG_Visual_Register_Lowercase' => 'Lowercase letters',
  'PLIGG_Visual_Register_FiveChar' => 'At least 5 characters',
  ...
  'PLIGG_Visual_Register_Description_Title' => 'Join Us',
  'PLIGG_Visual_Register_Description_Paragraph' => 'Don\'t just read the content, submit your own and participate by becoming a free member. By registering you unlock special privileges reserved for members such as...',
  'PLIGG_Visual_Register_Description_Points' => '<li>Submit content for others to vote on</li><li>Vote on articles that interest you</li><li>Save your favorite articles to your profile</li><li>View your voting and comment activity from your profile</li>',
  ...
  'PLIGG_Visual_Login_LoginButton' => 'Sign In',
  'PLIGG_Visual_Login_Have_Account' => 'Have an account?',
  'PLIGG_Visual_Login_NewUsers' => 'Register an Account',
  'PLIGG_Visual_Login_NewUsersA' => 'New user? ',
  'PLIGG_Visual_Login_NewUsersB' => 'Create a new account',
  'PLIGG_Visual_Login_NewUsersC' => ' to take part in all that this site has to offer. It\'s fast, easy and most important free.',
  'PLIGG_Visual_Login_ForgottenPassword' => 'Forgotten Password',
  'PLIGG_Visual_Login_EmailChangePass' => 'Forget your password? Enter your email address and we will send instructions on how to reset it.',
  ...
  'PLIGG_PassEmail_Subject' => 'Password Change',
  'PLIGG_PassEmail_Body' => 'We have received a request to reset your account password. If you would like to continue and select a new password now, please click on the following link. If you did not initiate this password request, just ignore this email to take no further action.',
  'PLIGG_PassEmail_PassBody' => 'Your password to %s has recently been reset. Please <a href=\'%s\'>login</a> using the account details below and change your password from the user profile section.<br><br><strong>Username</strong>: %s<br><strong>Password</strong>: %s',
  ...
  'PLIGG_Visual_Story_WhoVoted' => 'Who Upvoted this Tutorial',
  ...
  'PLIGG_Visual_LS_Admin_Edit' => 'Edit Article',
  'PLIGG_Visual_LS_Admin_Status' => 'Change the Status',
  'PLIGG_Visual_Recommend_Logged_In' => 'Error, you must be logged in!',
  'PLIGG_Visual_Recommend_Limit' => 'Sorry, you\'re sending too many emails, please wait and try again in a few moments.',
  ...
  'PLIGG_MiscWords_Save_Links_Save' => 'Add Bookmark',
  'PLIGG_MiscWords_Save_Links_Remove' => 'Remove Bookmark',
  ...
  'PLIGG_Visual_Story_Times_Days' => 'days',
  'PLIGG_Visual_Story_Times_Day' => 'day',
  'PLIGG_Visual_Story_Times_Hours' => 'hours',
  'PLIGG_Visual_Story_Times_Hour' => 'hour',
  'PLIGG_Visual_Story_Times_Minutes' => 'minutes',
  'PLIGG_Visual_Story_Times_Minute' => 'minute',
  'PLIGG_Visual_Story_Times_FewSeconds' => 'few seconds',
  'PLIGG_Visual_Submit' => 'Submit',
  'PLIGG_Visual_Submit1_Header' => 'Submit a New Tutorial',
  ...
  'PLIGG_Visual_Submit1_Instruct_4B' => 'You are the tutorial link editor, so explain what it is and why it is cool.',
  ...
  'PLIGG_Visual_Submit1_NewsURL' => 'Unique News URL',
  'PLIGG_Visual_Submit1_Continue' => 'Continue',
  'PLIGG_Visual_Submit2_Header' => 'Submit a New Story',
  'PLIGG_Visual_Submit2_Source' => 'Source URL',
  'PLIGG_Visual_Submit2_NewsURL' => 'Tutorial URL',
  'PLIGG_Visual_Submit2_URLTitle' => 'Suggested Title',
  'PLIGG_Visual_Submit2_Details' => 'Article Details',
  'PLIGG_Visual_Submit2_Title' => 'Tutorial Title',
  'PLIGG_Visual_Submit2_TitleInstruct' => ' Please enter the title of the story you are linking to. (max 400 characters)',
  'PLIGG_Visual_Submit2_Tags' => 'Tags',
  'PLIGG_Visual_Submit2_Tags_Inst1' => 'Short, generic words separated by \',\' (comma)',
  'PLIGG_Visual_Submit2_Tags_Example' => 'Examples:',
  'PLIGG_Visual_Submit2_Tags_Inst2' => 'web, programming, free software',
  'PLIGG_Visual_Submit2_No_HTMLTagsAllowed' => 'No HTML ',
  'PLIGG_Visual_Submit2_HTMLTagsAllowed' => 'Tags allowed',
  'PLIGG_Visual_Submit2_Description' => 'Description',
  'PLIGG_Visual_Submit2_DescInstruct' => 'Write your own description of the tutorial you are submitting. It should be about 2 to 4 sentences long.',
  'PLIGG_Visual_Submit2_Summary' => 'Summary',
  'PLIGG_Visual_Submit2_SummaryInstruct' => 'This text will appear when looking at this tutorial in \'summary\' mode, like when it\'s on the front page.',
  ...
  'PLIGG_Visual_Submit2_CatInstructSelect' => 'Please Select',
  ...
  'PLIGG_Visual_Submit2_Continue' => 'Save Changes and Submit',
  ...
  'PLIGG_Visual_Submit3_Header' => 'Confirm Details',
  ...
  'PLIGG_Visual_Submit3Errors_Incomplete' => 'Incomplete title or text, or either of these fields was shorter than the minimum allowed length',
  ...
  'PLIGG_Visual_Submit3Errors_Long_Title' => 'Title is too long',
  'PLIGG_Visual_Submit3Errors_Long_Content' => 'Content is too long',
  'PLIGG_Visual_Submit3Errors_Long_Tags' => 'Tags line is too long',
  'PLIGG_Visual_Submit3Errors_Long_Summary' => 'Summary is too long',
  'PLIGG_Visual_Total_Chars' => 'Total Characters',
  ...
  'PLIGG_Visual_Comments' => 'Comment Submissions',
  ...
  'PLIGG_Visual_Breadcrumb_Unpublished_Tab' => 'New',
  'PLIGG_Visual_Breadcrumb_Published' => 'Published Submissions',
  'PLIGG_Visual_Breadcrumb_Unpublished' => 'New Submissions',
  ...
  'PLIGG_Visual_TopUsers_TH_News' => 'Submissions',
  ...
  'PLIGG_Visual_TopUsers_TH_PublishedVotes' => 'Published Up Votes',
  'PLIGG_Visual_TopUsers_TH_Karma' => 'Karma',
  'PLIGG_Visual_Breadcrumb_SiteName' => 'My Site ',
  'PLIGG_Visual_Breadcrumb_Home' => 'Home',
  'PLIGG_Visual_Breadcrumb_Your_Location' => 'Your Location',
  'PLIGG_Visual_Breadcrumb_Queued' => 'New',
  ...
  'PLIGG_Visual_Breadcrumb_User_Killspam' => 'Killspam User',
  ...
  'PLIGG_Visual_User_Profile_Removing_Friend' => 'Removing Follower',
  'PLIGG_Visual_User_Profile_Add_Friend' => 'Follow',
  'PLIGG_Visual_User_Profile_Adding_Friend' => 'Adding Follower',
  'PLIGG_Visual_User_Profile_View_Friends' => 'Following',
  'PLIGG_Visual_User_Profile_Viewing_Friends' => 'People you\'re following',
  'PLIGG_Visual_User_Profile_Viewing_Friends_2' => 'Viewing Followers',
  'PLIGG_Visual_User_Profile_Viewing_Friends_2a' => 'People who are following',
  'PLIGG_Visual_User_Profile_No_Friends' => 'isn\'t following anyone.',
  'PLIGG_Visual_User_Profile_No_Friends_2' => 'No one is Following',
  'PLIGG_Visual_User_Profile_Your_Friends' => 'Followers',
  'PLIGG_Visual_User_Profile_Username' => 'Username',
  'PLIGG_Visual_User_Profile_Message' => 'Send Message',
  'PLIGG_Visual_User_Profile_Friend_Removed' => 'Successfully Removed User!',
  ...
  'PLIGG_Visual_User_Profile_Friends' => 'People I\'m Following',
  ...
  'PLIGG_Visual_Profile_ChangePass' => 'Change Password',
  ...
  'PLIGG_Visual_Profile_Save' => 'Save Changes',
  ...
  'PLIGG_Visual_AdminPanel_Groups' => 'Groups',
  'PLIGG_Visual_AdminPanel_Manage_Groups' => 'Manage Groups',
  'PLIGG_Visual_AdminPanel_New_Group' => 'Add a New Group',
  ...
  'PLIGG_Visual_AdminPanel_New' => 'New',
  ...
  'PLIGG_Visual_AdminPanel_Mark_New' => 'Mark all as New',
  ...
  'PLIGG_Visual_AdminPanel_New_User' => 'Create New User',
  ...
  'PLIGG_Visual_AdminPanel_Page_Submit_New' => 'Create a New Page',
  'PLIGG_Visual_AdminPanel_Page_HTML' => 'HTML and Smarty code is allowed',
  ...
  'PLIGG_Visual_Change_Link_Title' => 'Story Title',
  'PLIGG_Visual_Change_Link_URL' => 'Story URL',
  'PLIGG_Visual_Change_Link_Content' => 'Story Content',
  'PLIGG_Visual_Change_Link_Status2' => 'Story Status',
  'PLIGG_Visual_Change_Link_Submitted_By' => 'Story Author',
  ...
  'PLIGG_Visual_Ban_This_URL_List_All2' => 'Banned Domains',
  'PLIGG_Visual_Disable_This_USer' => 'Disable this User',
  'PLIGG_Visual_Change_Link_Discard' => 'A Discarded story is placed in a recycle bin, and is removed from the site.',
  'PLIGG_Visual_Change_Link_Queued' => 'An New story is one that has not yet made it to the homepage.',
  'PLIGG_Visual_Change_Link_Published' => 'A Published story is one that appears the homepage, and proceeding pages.',
  ...
  'PLIGG_Visual_View_User_Sub_Links' => 'View Submissions',
  ...
  'PLIGG_Visual_View_Backup_Previous' => 'Download your backup files by clicking on the links below. Make sure that you remove these files from the server once you have completed saving the files to your local computer.',
  ...
  'PLIGG_Visual_Submit_A_New_Group' => 'Create a Group',
  ...
  'PLIGG_Visual_Group_Avatar_Upload' => 'Change Image',
  'PLIGG_Visual_Submit_Add_To_Group' => 'Add to a Group',
  'PLIGG_Visual_Group_Story_Status' => 'Group story status',
  ...
  'PLIGG_Visual_Group_Submit_story' => 'Submit to a group',
  ...
  'PLIGG_Visual_Group_Email_Body' => 'Hello Group Admin<br />The member <a href=\'%s\'>%s</a> has requested to join your group.<br/><br/>To activate this user click here:<a href=\'%s\'>Activate</a><br /><br />To deactivate this user click this link: <a href=\'%s\'>Deactivate</a><br />',
  ...
  'PLIGG_Friendly_URLs_for_stories_Desc' => 'Use the story title in the url by setting this value to true. Example: /story/(story title)/<br />Keep this setting as TRUE if using URL Method 1',
  'PLIGG_Friendly_URLs_for_categories_Title' => 'Friendly URL\'s for categories',
  'PLIGG_Friendly_URLs_for_categories_Desc' => 'Use the category name in urls by setting this to true. Example: /category/(categoryname)/<br />Keep this setting as TRUE if using URL Method 1',
  ...
  'PLIGG_Base_URL_Desc' => '<br>n<strong>Examples</strong>n<br>nhttp://demo.pligg.com<br>nhttp://localhost<br>nhttp://www.pligg.com',
  'PLIGG_Pligg_Base_Folder_Title' => 'Pligg Base Folder',
  'PLIGG_Pligg_Base_Folder_Desc' => '<br>n<strong>Examples</strong>n<br>n/pligg -- if installed in the /pligg subfolder<br>nLeave blank if installed in the site root folder.',
  ...
  'PLIGG_Tag_Minimum_Font_Size_Desc' => '<strong>Only used if Tags are enabled.</strong> How small should the text for the smallest tags be.',
  'PLIGG_Tags_Maximum_Font_Size_Title' => 'Tags Maximum Font Size',
  'PLIGG_Tags_Maximum_Font_Size_Desc' => '<strong>Only used if Tags are enabled.</strong> How large should the text for the largest tags be.',
  ...
  'PLIGG_Main_Spam_Ruleset_Title' => 'Global Domain Blacklist File',
  'PLIGG_Main_Spam_Ruleset_Desc' => 'What file should be used to check for spam domains? This is an independent file from banned domains added through the Killspam feature.',
  'PLIGG_Local_Spam_Ruleset_Title' => 'Local Domain Blacklist File',
  'PLIGG_Local_Spam_Ruleset_Desc' => 'What file should Pligg write banned domains to if you mark a story or user as spam?',
  ...
  'PLIGG_HTML_tags_to_allow_to_Normal_users_Title' => 'HTML tags to allow for Normal users',
  'PLIGG_HTML_tags_to_allow_to_Normal_users_Desc' => 'leave blank to not allow tags. Examples include \'&lt;b>&lt;br>&lt;font>&lt;img>&lt;p>\' <strong>(without spaces)</strong>',
  ...
  'PLIGG_Enable_extra_fields_Desc' => 'Enable extra fields when submitting stories?',
  ...
  'PLIGG_Comment_Sort_Order_Desc' => '<br><strong>1</strong> = Top rated comments first, newest on topn<br><strong>2</strong> = Newest comments first	n<br><strong>3</strong> = Top rated comments first, oldest on topn<br><strong>4</strong> = Oldest comments first',
  'PLIGG_Recommend_Type_Title' => 'Recommend_Type',
  'PLIGG_Recommend_Type_Desc' => '',
  'PLIGG_Allow_friends_Title' => 'Allow Followers',
  'PLIGG_Allow_friends_Desc' => 'Allow adding, removing, and viewing followers.',
  ...
  'PLIGG_Who_Sent_2_Desc' => 'What appears after the user name. <strong>Keep a space in the beginning and end.</strong>',
  ...
  'PLIGG_Search_method_Desc' => '<br /><strong>1</strong> = uses MySQL MATCH for FULLTEXT indexes (or something). <strong>Problems are MySQL STOP words and words less than 4 characters. Note: these limitations do not affect clicking on a TAG to search by it.</strong>n<br /><strong>2</strong> = uses MySQL LIKE and is much slower, but returns better results. Also supports &quot;*&quot; and &quot;-&quot;n<br /><strong>3</strong> = is a hybrid, using method 1 if possible, but method 2 if needed.',
  ...
  'PLIGG_Outgoing_Links_Placement_Desc' => 'What identifier should the out.php URL use?',
  ...
  'PLIGG_Avatar_Storage_Directory_Desc' => 'This is the directory relative to your Pligg install where you want to store avatars.<br />Ex: if you installed in a subfolder named pligg, you only put /avatars/user_uploaded and NOT /pligg/avatarsuser_uploaded.',
  ...
  'PLIGG_Tag_minimum_points_sidebar_Desc' => '<strong>Only used if Tags are enabled.</strong> How small should the text for the smallest tags in the sidebar cloud?',
  'PLIGG_Tag_Maximum_Points_sidebar_Title' => 'Tag Maximum Points (sidebar)',
  'PLIGG_Tag_Maximum_Points_sidebar_Desc' => '<strong>Only used if Tags are enabled.</strong> How big should the text for the largest tags be in the sidebar cloud?',
  'PLIGG_Tag_Cloud_Word_Limit_sidebar_Title' => 'Tag Cloud Word Limit (sidebar)',
  'PLIGG_Tag_Cloud_Word_Limit_sidebar_Desc' => '<strong>Only used if Tags are enabled.</strong> How many tags to show in the sidebar cloud?',
  ...
  'PLIGG_Votes_Allowed_from_one_IP_Desc' => 'This feature is turned on by default to prevent users from voting from multiple registered accounts from the same computer network. <strong>0</strong> = disable feature.',
  'PLIGG_Limit_time_to_edit_stories_Title' => 'Limit time to edit stories',
  'PLIGG_Limit_time_to_edit_stories_Desc' => 'This feature allows you to limit the amount of time a user has before they can no longer edit a submitted story.<br /><strong>0</strong> = Unlimited amount of time to edit<br><strong>1</strong> = specified amount of time',
  ...
  'PLIGG_Minutes_before_a_user_is_no_longer_allowed_to_edit_a_story_Desc' => '<strong>0</strong> = Disable the users ability to ever edit the story. Requires that you enable Limit Time To Edit Stories (set to 1).',
  ...
  'PLIGG_HTML_tags_to_allow_to_Admin_users_Title' => 'HTML tags to allow for Moderators',
  'PLIGG_HTML_tags_to_allow_to_Admin_users_Desc' => 'leave blank to not allow tags. Examples include \'&lt;b>&lt;br>&lt;font>&lt;img>&lt;p>\'',
  'PLIGG_HTML_tags_to_allow_to_God_Title' => 'HTML tags to allow for Admins',
  'PLIGG_HTML_tags_to_allow_to_God_Desc' => 'leave blank to not allow tags. Examples include \'&lt;b>&lt;br>&lt;font>&lt;img>&lt;p>\'',
  ...
  'PLIGG_Visual_This_All' => 'All',
  'PLIGG_Visual_Tags_All_Tags' => 'All',
  ...
  'PLIGG_Validation_Message' => 'Your account has been activated! <a href=\'%s\'>Click here</a> to login.',
  ...
  'PLIGG_Visual_AdminPanel_Module_Description' => 'Modules add new features to your Pligg CMS site without you having to modify any of the \'core\' code. You can customize your site by adding new features, or alter existing features built into Pligg through Modules. Upload modules to your server\'s /modules directory.',
  ...
  'PLIGG_Visual_AdminPanel_Cleared_Cache_Message' => 'Your cache directories have successfully been cleared!<br /><br />Deleting the contents of the cache directories (/cache) is often required when making changes to your templates, or when adding and removing modules or widgets.',
  ...
  'PLIGG_Visual_AdminPanel_Optimized_Message' => 'Your MySQL database has successfully been optimized!<br /><br />You should occassionally optimize your database to keep your MySQL data from fragmenting or corrupting. In some cases, running the optimization feature may result in improved database performance.',
  ...
  'PLIGG_Visual_AdminPanel_Template_Cant_Open' => 'Could not open directory! <br />Check your CHMOD settings. The templates directory and files should be set to CHMOD 0777.',
  ...
  'PLIGG_Visual_Story_Who_Upvoted' => 'Who Upvoted',
  'PLIGG_Visual_Story_Who_Downvoted' => 'Who Downvoted',
  'PLIGG_Visual_Story_Who_Downvoted_Story' => 'Who Downvoted this Story',
  'PLIGG_Maintenance_Mode' => 'Maintenance Mode',
  'PLIGG_Maintenance_Admin_Warning' => '<strong>Warning!</strong> Maintenance Mode is currently active. Remove the .maintenance file from your Pligg directory to disable it.',
  'PLIGG_Visual_New_Password' => 'New Password',
  'PLIGG_Visual_New_Verify_Password' => 'Verify New password',
  'PLIGG_Password_Invalid_URL' => 'The link that you followed was invalid or incomplete.',
  'PLIGG_Visual_Resend_Email' => 'Your email is not validated yet. Please enter your email address here to resend confirmation message:',
  'PLIGG_Visual_Email_Sent' => 'If the email address exists in our database you will be sent a confirmation email soon.',
  'PLIGG_Submit3Errors_Short_Tags' => 'Tags line is too short',
  'PLIGG_Visual_Profile_UsernameUpdated' => 'Your username has been updated',
  'Pligg_Profile_No_Membership' => 'This user is not a member of any groups yet.',
  'PLIGG_Visual_User_Profile_People' => 'People',
  'PLIGG_Visual_User_Profile_Is_Following' => 'is following',
  'PLIGG_User_Profile_Social' => 'Social Accounts',
  ...
  'PLIGG_User_Display_Settings' => 'Display Settings',
  'PLIGG_Continue_Reading' => 'Continue Reading',
  'PLIGG_No_More_Articles' => 'No More Articles Found',
  'PLIGG_Follow' => 'Follow',
  'PLIGG_Unfollow' => 'Unfollow',
  'PLIGG_Visual_AdminPanel_Backup_None' => 'No backups have been generated yet! Start by clicking on one of the buttons above.',
  'PLIGG_Admin_Template_Widget_Title' => 'Template Widget Management',
  'PLIGG_Admin_Template_Widget_Description' => 'Drag and drop the items below to manage their display order in the template sidebar.',
  'PLIGG_Visual_UpVoted' => 'Upvoted',
  'PLIGG_Visual_DownVoted' => 'Downvoted',
  'PLIGG_User_Profile_No_Content' => 'This page does not have any content to display at this time.',
); ?>