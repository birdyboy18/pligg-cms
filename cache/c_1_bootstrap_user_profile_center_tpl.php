						...
						<thead class="table_title">
							<tr>
								...
								<?php if ($this->_vars['user_login'] == $this->_vars['user_logged_in']): ?>
									<th><?php echo $this->_confs['PLIGG_Visual_User_Profile_Remove_Friend']; ?>
</th>
								<?php endif; ?>
							</tr>
						</thead>
