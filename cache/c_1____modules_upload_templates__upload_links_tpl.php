...
<?php echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_module_upload_start"), $this); $this->config_load(upload_lang_conf, null, null); ?>
...
<?php if (sizeof ( $this->_vars['images'] )): ?>
	<h3><?php echo $this->_confs['PLIGG_Upload_Attached']; ?>
</h3>
...
'><?php echo $this->_vars['image']['file_name']; ?>
		...
		<?php endif; ?>
	    <?php endif; ?>
	<?php endforeach; endif;  echo $this->_vars['upload_post_format']; ?>

<?php endif; ?>

<?php $this->config_load(upload_pligg_lang_conf, null, null);  echo tpl_function_checkActionsTpl(array('location' => "tpl_pligg_module_upload_end"), $this);?>