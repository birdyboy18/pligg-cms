...
<br />
		...
		<input type="checkbox" name="new" value="1" <?php if ($this->_vars['sw_new'] == "1"): ?>checked<?php endif; ?>> <?php echo $this->_confs['PLIGG_Statistics_Widget_New']; ?>
<br />
...
<br />
	...
	<p style="margin:0 0 5px 8px;">
		<input type="submit" class="btn btn-primary" value="<?php echo $this->_confs['PLIGG_Statistics_Widget_Save']; ?>
">
	</p>
</form>